...
public class MultiTenancyJpaConfiguration {
    ...
    /**
     * Builds a map of all data sources defined in the file
     * 
     * @return
     */
...
System.out.println("abcancz");
     ...
     * instance.
     * 
     * {@link org.springframework.transaction.PlatformTransactionManager} is the central interface
     * in Spring's transaction infrastructure. Applications can use this directly, but it is not
     * primarily meant as API: Typically, applications will work with either TransactionTemplate or
